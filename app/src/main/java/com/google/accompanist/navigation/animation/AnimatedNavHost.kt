...
public fun AnimatedNavHost(
    ...
    if (backStackEntry != null) {
        ...
        val currentTransition = transition ?: updateTransition(backStackEntry, label = "entry")
        currentTransition.AnimatedContent(
            modifier,
            transitionSpec = {
        ...
        if (currentTransition.currentState == currentTransition.targetState) {
